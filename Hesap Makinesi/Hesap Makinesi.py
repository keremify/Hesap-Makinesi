...
class HesapMakinesi(Tk):
    def __init__(self,master):
        master.title("Hesap Makinesinatör 3000")
        ...
        self.entry_value = ''
        self.entry = Entry(width=17, bg="gray", font=("Arial Bold", 28), textvariable=self.equation, state="readonly")
    ...
    def solve(self):
      try:
          ...
          self.equation.set("Hatalı işlem girdiniz.")

root = Tk()
calculator = HesapMakinesi(root)
root.mainloop()